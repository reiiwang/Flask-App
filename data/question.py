...
questions = [
    ...
    },
    {
        ...
        "options": ["1: 非常通順 100%","2: 較為通順 >50%","3: 不太通順 <50%", "4: 非常不通順 0%"],
    ...
    },
    {
        ...
        "options_note": ["完全正確 100% (不考慮答案是否符合第一題與第二題的情況下，基於問題與證據，答案中的資訊正確，與證據或已知事實一致。)",
                         ...
                         "部分正確 <50% (不考慮答案是否符合第一題與第二題的情況下，基於問題與證據，答案中只有一部分資訊是正確的，大部分內容有誤。)",
                         "完全不正確 0% (不考慮答案是否符合第一題與第二題的情況下，基於問題與證據，答案中的所有資訊都是錯誤的，沒有一部分是正確的。)"]
    }
]
