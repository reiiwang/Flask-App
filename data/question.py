Contexts = [
    {
        "Evidence": "1. You'll start with over-the-counter pain relievers like ibuprofen or naproxen to ease the swelling. 你可以先使用布洛芬或萘普生等非處方止痛藥來緩解腫脹。\n2. But try these methods at home to feel better and keep your thumb healthy: Ice the area to ease inflammation. 但是在家嘗試這些方法可以感覺更好並保持拇指健康：冰敷該區域以緩解發炎。",
